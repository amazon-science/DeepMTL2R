...
class LTRModel(nn.Module):
    ...
    def score(self, x, mask, indices):
     ...
     # Add shared parameter methods
    def shared_parameters(self):
        """Return shared parameters for weight methods."""
        return list(self.input_layer.parameters()) + list(self.encoder.parameters())

    def task_specific_parameters(self):
        """Return task-specific parameters for weight methods."""
        return list(self.output_layer.parameters())

    def last_shared_parameters(self):
        """Return parameters of the last shared layer (if applicable)."""
        # If no specific last shared layer, return empty
        return []
